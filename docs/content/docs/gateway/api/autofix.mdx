...
The example uses AgentInterface with saved broken programs and a composer for custom OpenUI Lang. Assistant replies show the repair status, code, diagnostics, and rendered result. Its API key stays in a Next.js server route.
