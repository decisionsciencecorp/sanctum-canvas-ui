...
const completion = await client.chat.completions.create({
  ...
  messages: [
    // Send your actual component-library spec in the first turn.
...
For an AgentInterface example that calls OpenAI directly and automatically repairs invalid output, see the [Autofix example](https://github.com/thesysdev/openui/tree/main/examples/miscellaneous/autofix).
